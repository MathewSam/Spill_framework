...
### test_batch_norm.py
Testing module to test whether the batchnorm operations work using gradient checking

### test_CNN.py
Testing module to test whether the CNN operations work using gradient checking

*The tests can be run by simply running pytest -v
